...
class ExcelWriter:
    ...
    def save_results(self):
        ...
        # TODO: add a boolean as an argument (e.g. coming from a "Download Results" button)
        # if they want to export the results as an excel file
    ...
    def save_sat_preferences(self):
        ...
        self.write_sat_preferences(df, top_6_preferences_satisfaction_ratios) # TODO: taking the same boolean as above
